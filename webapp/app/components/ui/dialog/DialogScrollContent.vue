  ...
  <DialogPortal>
    ...
    >
      ...
      >
        ...
        <DialogClose
          class="absolute top-4 right-4 rounded border border-border bg-card p-1 text-muted-foreground transition-all duration-200 hover:bg-accent hover:text-foreground"
        >
          <X class="w-4 h-4" />
